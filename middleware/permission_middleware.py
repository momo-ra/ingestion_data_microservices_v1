...
class Permissions:
    ...
    CREATE_PLANT_DATA = "create_plant_data"
    UPDATE_PLANT_DATA = "update_plant_data"
    DELETE_PLANT_DATA = "delete_plant_data"
            ...
            if not has_permission:
                ...
                raise HTTPException(
                    ...
                    detail=fail_response(
                        message=f"Forbidden: No access to plant {plant_id} or insufficient permissions",
                        data={
    ...
    async def __call__(
        ...
        if not has_access:
            ...
            raise HTTPException(
                status_code=403, 
                detail=fail_response(
                    message="Access denied: You don't have permission to access this workspace",
                    data={
        ...
        if not is_owner:
            ...
            raise HTTPException(
                ...
                detail=fail_response(
                    ...
                    data={
                        "error_type": "workspace_ownership_required",
                        "workspace_id": workspace_id
                    }
                )
            )
